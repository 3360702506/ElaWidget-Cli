...
#include <memory>
#include "../../ELaCli/template/generate.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_Generate_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_Generate_t qt_meta_stringdata_Generate = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_Generate[] = {
...
Q_CONSTINIT const QMetaObject Generate::staticMetaObject = { {
    ...
    qt_meta_stringdata_Generate.offsetsAndSizes,
    qt_meta_data_Generate,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_Generate_t,
        // Q_OBJECT / Q_GADGET
